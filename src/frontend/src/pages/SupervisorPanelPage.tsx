...
function SupervisorDashboard({
  ...
  return (
    <div
      data-ocid="supervisor-panel.supervisor-dashboard.panel"
      style={{
        minHeight: "100vh",
        background:
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          >
            ...
            <span
              style={{ color: "#fcd34d", fontSize: "13px", fontWeight: 600 }}
            >
              {user.name}
            </span>
            <span
      ...
      >
          ...
          {(["overview", "request"] as const).map((section) => (
            <button
              ...
              style={{
                ...
                color: activeSection === section ? "#fcd34d" : "#64748b",
                borderRadius: "8px",
                padding: "8px 20px",
                fontSize: "13px",
                fontWeight: 600,
          ...
          <div>
            ...
            >
              ...
              >
                ...
                To modify data, use the "Submit Update Request" tab. Your
        ...
        {activeSection === "request" && (
          <div style={{ maxWidth: "560px" }}>
            ...
            >
              <div>
                <label htmlFor="sv-update-data-type" style={labelStyle}>
                  DATA TYPE
                </label>
                <select
                  id="sv-update-data-type"
                  value={dataType}
              ...
              <div>
                <label htmlFor="sv-update-description" style={labelStyle}>
                  DESCRIPTION
                </label>
                <textarea
                  id="sv-update-description"
                  value={description}
              ...
              <button
                type="submit"
                disabled={submitting}
                data-ocid="supervisor-panel.update-request.submit_button"
                style={{
                  background: "linear-gradient(135deg, #d97706, #f59e0b)",
                  border: "none",
                  color: "white",
...
export function SupervisorPanelPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.role !== "Supervisor") {
        setError(
          "Access Denied. This account does not have Supervisor privileges.",
        );
        return;
      }
  ...
  // If logged in, show the supervisor dashboard
  if (loggedInUser) {
    return <SupervisorDashboard user={loggedInUser} onLogout={handleLogout} />;
  }
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    data-ocid="supervisor-panel.userid.input"
                    style={{
                      width: "100%",
                      background: "rgba(255,255,255,0.06)",
                      border: "1px solid rgba(255,255,255,0.12)",
                ...
                <div style={{ textAlign: "center", paddingTop: "4px" }}>
                  <button
                    ...
                    data-ocid="supervisor-panel.register-link.button"
                    style={{
                      background: "none",
                      border: "none",
                      color: "#fbbf24",
